...
contract('TutorialToken', function(accounts){
    ...
    it('initializes the contract with the correct values', function() {
        return TutorialToken.deployed().then(function(instance) {
            ...
            assert.equal(name, 'Tutorial Token', 'has the correct name');
            return tokenInstance.symbol();
        }).then(function(symbol) {
            assert.equal(symbol, 'TUT', 'has the correct symbol');
            return tokenInstance.standard();
        }).then(function(standard) {
            assert.equal(standard, 'Tutorial Token v1.0', 'has the correct standard');
        });
    });
    ...
    it('should handle delegated transfer', function() {
        return TutorialToken.deployed().then(function(instance) {
            tokenInstance = instance;
